...
TARGET_SHEET_ID = "3345833765326724"

# Column mappings
COLUMN_MAPPING = {
    7525747076059012: 2519342446759812,  # FOREMAN -> Foreman
    488872658292612: 267542633074564,    # WORK REQUEST # -> WR #
    2740672471977860: 4771142260445060   # LOCATION -> City
}

# Column IDs
SOURCE_WR_NUMBER_COLUMN_ID = 488872658292612
TARGET_WR_NUMBER_COLUMN_ID = 267542633074564
FOREMAN_COLUMN_ID = 7525747076059012
COMPLETED_DATE_COLUMN_ID = 1051822611713924   # Source Completed Date
TARGET_COMPLETED_DATE_COLUMN_ID = 5897042167287684  # Target Completed Date

VALID_FOREMEN = [
    "Francisco Ochoa III", "Armando Garcia", "Isaac Atkinson"
]
