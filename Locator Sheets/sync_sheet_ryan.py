...
VALID_FOREMEN = [
   "Everado Arechiga", "Everado Arechiga Jr", "John Flores", "Carlos Villanueva","Julio Martinez", "Justin Vargas", "Jose Gallardo", "Ralph Rodriguez","Cergio Garcia", "Roberto Morales", "Enrique Gaytan","Javier Trevino" 
]
